...
const ease: Easing = [0.42, 0, 0.58, 1]; // equivalente a easeOut
  ...
  return (
    <div className="py-10 w-full flex flex-col items-center justify-center overflow-hidden mt-12">
          ...
          >
            <Link
              ...
              className={`text-sm font-[HandoRegular] underline-offset-13 hover:underline ${
                link.href === "/products/hoodies" ? "underline decoration-2" : ""
              }`}
            >
              {link.label}
            </Link>
      ...
      >
        ...
        >
          {[
            { href: "/products/hoodies", img: "/tech/hoodie.jpg", label: t("nav.hoodies") },
          ].map((item, idx) => (
